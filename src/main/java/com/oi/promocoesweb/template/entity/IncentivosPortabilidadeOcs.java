 ...
 * @author Jpereirc
 */
public class IncentivosPortabilidadeOcs extends Template {
    ...
    public IncentivosPortabilidadeOcs() {
        super();
    }

    public IncentivosPortabilidadeOcs(IncentivosPortabilidadeOcs selectedConfigOfertasPre) {
    ...
    public void setHistory(String history) throws Exception {
        if (history != null && !"".equals(history)) {
            try {
                ...
                IncentivosPortabilidadeOcs[] pp1 = mapper.readValue(history, IncentivosPortabilidadeOcs[].class);
                setHistory(Arrays.asList(mapper.readValue(history, IncentivosPortabilidadeOcs[].class)));

                Date tempDate = new Date(0);
                User tempUser = null;
                for (IncentivosPortabilidadeOcs template : pp1) {
