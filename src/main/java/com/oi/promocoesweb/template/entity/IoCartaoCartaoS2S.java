 ...
 * @author Jpereirc
 */
public class IoCartaoCartaoS2S extends Template {
    ...
    public IoCartaoCartaoS2S() {
        super();
    }

    public IoCartaoCartaoS2S(IoCartaoCartaoS2S selectedConfigOfertasPre) {
    ...
    public void setHistory(String history) throws Exception {
        if (history != null && !"".equals(history)) {
            try {
                ...
                IoCartaoCartaoS2S[] pp1 = mapper.readValue(history, IoCartaoCartaoS2S[].class);
                setHistory(Arrays.asList(mapper.readValue(history, IoCartaoCartaoS2S[].class)));

                Date tempDate = new Date(0);
                User tempUser = null;
                for (IoCartaoCartaoS2S template : pp1) {
