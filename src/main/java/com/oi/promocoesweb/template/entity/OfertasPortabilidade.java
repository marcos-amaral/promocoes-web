 ...
 * @author Jpereirc
 */
public class OfertasPortabilidade extends Template {
    ...
    public OfertasPortabilidade() {
        super();
    }

    public OfertasPortabilidade(OfertasPortabilidade selectedConfigOfertasPre) {
    ...
    public void setHistory(String history) throws Exception {
        if (history != null && !"".equals(history)) {
            try {
                ...
                OfertasPortabilidade[] pp1 = mapper.readValue(history, OfertasPortabilidade[].class);
                setHistory(Arrays.asList(mapper.readValue(history, OfertasPortabilidade[].class)));

                Date tempDate = new Date(0);
                User tempUser = null;
                for (OfertasPortabilidade template : pp1) {
