...
@Named
@ViewScoped
public class TbTemplateControleBean extends TemplateBean<TbTemplateControle> implements Serializable{
    private static final Logger logger = LogManager.getLogger();

    private final TabelasEnum tabelasEnum = TabelasEnum.TB_TEMPLATE_CONTROLE;
    ...
    public void init() {
        ...
        try {
            ...
            super.clearVarsEdit(new TbTemplateControle());
            super.clearVarsAdd(new TbTemplateControle());
    ...
    public void preLoadEditBean() {
        if (this.getSelectedTemplateList().size() == 1) {
            this.setEditTemplate(new TbTemplateControle(this.getSelectedTemplateList().get(0)));
            this.getEditTemplate().setUser(super.getUser());
            this.setNewTemplate(new TbTemplateControle(this.getSelectedTemplateList().get(0)));
            this.getNewTemplate().setUser(super.getUser());
        } else {
            this.setEditTemplate(new TbTemplateControle());
            this.getEditTemplate().setUser(super.getUser());
            this.setNewTemplate(new TbTemplateControle());
            this.getNewTemplate().setUser(super.getUser());
        }
    ...
    public void generateScriptFile(String aplicacao) {
        ...
        List<TbTemplateControle> list = null;
        ...
        if (list != null) {
            ...
            int i;
            for (TbTemplateControle registro : list) {
    ...
    @Override
    public List<TbTemplateControle> getTemplateList() {
        return (List<TbTemplateControle>) (Object) super.getTemplateList();
    }

    @Override
    public List<TbTemplateControle> getSelectedTemplateList() {
        return (List<TbTemplateControle>) (Object) super.getSelectedTemplateList();
    }

    @Override
    public TbTemplateControle getNewTemplate() {
        return (TbTemplateControle) super.getNewTemplate();
    }

    @Override
    public List<TbTemplateControle> getNewTemplateList() {
        return (List<TbTemplateControle>) (Object) super.getNewTemplateList();
    }

    @Override
    public TbTemplateControle getEditTemplate() {
        return (TbTemplateControle) super.getEditTemplate();
    }

    public void setTemplatePreList(List<TbTemplateControle> configOfertasPreList) {
        super.setTemplateList(configOfertasPreList);
    }

    @Override
    public void setSelectedTemplateList(List<TbTemplateControle> selectedConfigOfertasPreList) {
        super.setSelectedTemplateList(selectedConfigOfertasPreList);
    }

    @Override
    public void setNewTemplate(TbTemplateControle newConfigOfertasPre) {
        super.setNewTemplate(newConfigOfertasPre);
    }

    @Override
    public void setEditTemplate(TbTemplateControle editConfigOfertasPre) {
        super.setEditTemplate(editConfigOfertasPre);
    }

    public List<TbTemplateControle> getSelectedTemplateHistoryList() {
        if (super.getSelectedTemplateList() != null && super.getSelectedTemplateList().size() > 0) {
            List<TbTemplateControle> history = (List<TbTemplateControle>) (Object) super.getSelectedTemplateList().get(0).getHistory();

            for (TbTemplateControle bean : history) {
    ...
    public LazyDataModel<TbTemplateControle> getDataModel() {
        return (LazyDataModel<TbTemplateControle>) (Object) super.getDataModel();
    }
    ...
    //CUSTOM METHODS//////////////////////////////////////////////////////
    public TbTemplateControle getNewTemplate(Integer size, Integer index, String ddd, Date dt_gmud) {
        if (super.getNewTemplateList().size() <= index) {
            for (int i = 0; i < index; i++) {
                if (i == index) {
                    TbTemplateControle tbTemplateControle = new TbTemplateControle();
                    tbTemplateControle.setDdd(ddd);
                    tbTemplateControle.setDt_gmud(dt_gmud);
                    tbTemplateControle.setUser(getUser());
                    super.getNewTemplateList().add(tbTemplateControle);
        ...
        if (super.getNewTemplate(index) == null) {
            ...
            tbTemplateControle.setDt_gmud(dt_gmud);
            tbTemplateControle.setUser(getUser());
            super.getNewTemplateList().set(index, tbTemplateControle);
        } else {
            ((TbTemplateControle) super.getNewTemplate(index)).setDdd(ddd);
            ((TbTemplateControle) super.getNewTemplate(index)).setDt_gmud(dt_gmud);
            ((TbTemplateControle) super.getNewTemplate(index)).setUser(getUser());
        }

        return (TbTemplateControle) super.getNewTemplate(index);
    }
}
