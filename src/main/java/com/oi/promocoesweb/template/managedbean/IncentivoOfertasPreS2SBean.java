...
@Named
@ViewScoped
public class IncentivoOfertasPreS2SBean extends TemplateBean<IncentivoOfertasPreS2S> implements Serializable {

    private static final Logger logger = LogManager.getLogger();

    private final TabelasEnum tabelasEnum = TabelasEnum.INCENTIVO_OFERTASPRE_S2S;

    private List<String> validIdOfertaOcsListS2S;
    ...
    public void init() {
        ...
        try {
            ...
            super.clearVarsEdit(new IncentivoOfertasPreS2S());
            super.clearVarsAdd(new IncentivoOfertasPreS2S());
            ...
            if (dt_gmud_incentivo != null) {
                validIdOfertaOcsListS2S = TemplateControl.getValidIdOfertaOcsS2S(dt_gmud_incentivo);
            }
    ...
    public void reloadGmud() {
        ...
        try {
            ...
            validIdOfertaOcsListS2S = TemplateControl.getValidIdOfertaOcsS2S(getNewTemplate().getDt_gmud());
    ...
    public void reloadEditGmud() {
        ...
        try {
            if (getEditTemplate().getDt_gmud() != null) {
                validIdOfertaOcsListS2S = TemplateControl.getValidIdOfertaOcsS2S(getEditTemplate().getDt_gmud());
            } else if (getDefaultFilterValue() != null && !"PRODUCAO".equals(getDefaultFilterValue())) {
                validIdOfertaOcsListS2S = TemplateControl.getValidIdOfertaOcsS2S(new SimpleDateFormat("dd/MM/yy").parse(getDefaultFilterValue()));
            }
    ...
    public void preLoadEditBean(Boolean reloadEditGmud) {
        if (getSelectedConfigOfertasPreList().size() == 1) {
            setEditTemplate(new IncentivoOfertasPreS2S(getSelectedConfigOfertasPreList().get(0)));
            getEditConfigOfertasPre().setUser(super.getUser());
            setNewTemplate(new IncentivoOfertasPreS2S(getSelectedConfigOfertasPreList().get(0)));
            getNewConfigOfertasPre().setUser(super.getUser());
        } else {
            setEditTemplate(new IncentivoOfertasPreS2S());
            getEditConfigOfertasPre().setUser(super.getUser());
            setNewTemplate(new IncentivoOfertasPreS2S());
            getNewConfigOfertasPre().setUser(super.getUser());
        }
    ...
    public void generateScriptFile(String aplicacao) {
        ...
        List<IncentivoOfertasPreS2S> list = null;
        ...
        if (list != null) {
            ...
            for (IncentivoOfertasPreS2S registro : list) {
                ...
                switch (aplicacao) {
                    case "USSD":
                        if (super.getDefaultFilterValue() == null) {
                            ...
                            for (IncentivoOfertasPreS2S registroDel : list) {
                        ...
                        script.append(sb.toString()
                                ...
                                .replace("VAR" + (i++) + ",", "'" + registro.getRecacumuladamesanteriorinicial() + "',")
                                .replace("VAR" + (i++) + ",", "'" + registro.getRecacumuladamesanteriorfinal() + "',")
                    ...
                    case "144":
                        ...
                        sb.append("INSERT INTO TB_INCENTIVO_OFERTASOCSPRE_S2S");
                        sb.append(" (DDD,RECACUMULADAINICIAL,RECACUMULADAFINAL,OFERTAPROMO1_ID_OFERTAOCS,OFERTAPROMO2_ID_OFERTAOCS) ");
                        sb.append("VALUES (VAR1,VAR2,VAR3,VAR4,VAR5);");
                        ...
                        inputStream = new ByteArrayInputStream(
                                script.toString()
                                        .replace("RECACUMULADAMESANTERIORINICIAL", "REC_ACUMULADA_MES_ANTERIOR_INICIAL")
                                        .replace("RECACUMULADAMESANTERIORFINAL", "REC_ACUMULADA_MES_ANTERIOR_FINAL")
                    ...
                    case "880":
                        if (super.getDefaultFilterValue() == null) {
                            sb.append("DELETE FROM OCS_INCENTIVO_OFERTASPRE_S2S;\n");
                            script.append(sb.toString());
                        ...
                        sb.append("INSERT INTO OCS_INCENTIVO_OFERTASPRE_S2S");
                        sb.append(" (DDD,RECACUMULADAMESANTERIORINICIAL,RECACUMULADAMESANTERIORFINAL,OFERTAPROMO1,OFERTAPROMO2) ");
                        sb.append("VALUES (VAR1,VAR2,VAR3,VAR4,VAR5);");
                        ...
                        inputStream = new ByteArrayInputStream(
                                script.toString()
                                        .replace("RECACUMULADAMESANTERIORINICIAL", "IN_RECACUMULADAMESANTERIORINICIAL")
                                        .replace("RECACUMULADAMESANTERIORFINAL", "IN_RECACUMULADAMESANTERIORFINAL")
            ...
            defaultStreamedContent.setName("incentivo_ofertaspre_s2s.sql");
...
*/
    ...
    @Override
    public List<IncentivoOfertasPreS2S> getTemplateList() {
        return (List<IncentivoOfertasPreS2S>) (Object) super.getTemplateList();
    }

    public List<IncentivoOfertasPreS2S> getConfigOfertasPreList() {
        return (List<IncentivoOfertasPreS2S>) (Object) super.getTemplateList();
    }

    public List<IncentivoOfertasPreS2S> getSelectedConfigOfertasPreList() {
        return (List<IncentivoOfertasPreS2S>) (Object) super.getSelectedTemplateList();
    }

    public IncentivoOfertasPreS2S getNewConfigOfertasPre() {
        return (IncentivoOfertasPreS2S) super.getNewTemplate();
    }

    @Override
    public List<IncentivoOfertasPreS2S> getNewTemplateList() {
        return (List<IncentivoOfertasPreS2S>) (Object) super.getNewTemplateList();
    }

    public IncentivoOfertasPreS2S getEditConfigOfertasPre() {
        return (IncentivoOfertasPreS2S) super.getEditTemplate();
    }

    public void setConfigOfertasPreList(List<IncentivoOfertasPreS2S> configOfertasPreList) {
        super.setTemplateList(configOfertasPreList);
    }

    public void setSelectedConfigOfertasPreList(List<IncentivoOfertasPreS2S> selectedConfigOfertasPreList) {
        super.setSelectedTemplateList(selectedConfigOfertasPreList);
    }

    public void setNewConfigOfertasPre(IncentivoOfertasPreS2S newConfigOfertasPre) {
        super.setNewTemplate(newConfigOfertasPre);
    }

    public void setEditConfigOfertasPre(IncentivoOfertasPreS2S editConfigOfertasPre) {
        super.setEditTemplate(editConfigOfertasPre);
    }

    public List<IncentivoOfertasPreS2S> getSelectedConfigOfertasPreHistoryList() {
        if (super.getSelectedTemplateList() != null && super.getSelectedTemplateList().size() > 0) {
            List<IncentivoOfertasPreS2S> history = (List<IncentivoOfertasPreS2S>) (Object) super.getSelectedTemplateList().get(0).getHistory();

            for (IncentivoOfertasPreS2S bean : history) {
    ...
    public LazyDataModel<IncentivoOfertasPreS2S> getDataModel() {
        return (LazyDataModel<IncentivoOfertasPreS2S>) (Object) super.getDataModel();
    }
    ...
    //CUSTOM METHODS///////////////////////////////////////////////////////
    public IncentivoOfertasPreS2S getNewTemplate(Integer size, Integer index, String ddd, Date dt_gmud) {
        if (super.getNewTemplateList().size() <= index) {
            for (int i = 0; i < index; i++) {
                if (i == index) {
                    IncentivoOfertasPreS2S incentivoOfertasPreS2s = new IncentivoOfertasPreS2S();
                    incentivoOfertasPreS2s.setDdd(ddd);
                    incentivoOfertasPreS2s.setDt_gmud(dt_gmud);
                    incentivoOfertasPreS2s.setUser(getUser());
                    super.getNewTemplateList().add(incentivoOfertasPreS2s);
        ...
        if (super.getNewTemplate(index) == null) {
            ...
            incentivoOfertasPreS2s.setDt_gmud(dt_gmud);
            incentivoOfertasPreS2s.setUser(getUser());
            super.getNewTemplateList().set(index, incentivoOfertasPreS2s);
        } else {
            ((IncentivoOfertasPreS2S) super.getNewTemplate(index)).setDdd(ddd);
            ((IncentivoOfertasPreS2S) super.getNewTemplate(index)).setDt_gmud(dt_gmud);
            ((IncentivoOfertasPreS2S) super.getNewTemplate(index)).setUser(getUser());
        }

        return (IncentivoOfertasPreS2S) super.getNewTemplate(index);
    }

    public List<String> getValidIdOfertaOcsListS2S() {
        return validIdOfertaOcsListS2S;
    }

    public boolean isValidIdOfertaOcsValue(String valor, IncentivoOfertasPreS2S incentivoOfertasPreS2s) {
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo1_1())) {
            return false;
        }
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo1_2())) {
            return false;
        }
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo1_3())) {
            return false;
        }
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo2_1())) {
            return false;
        }
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo2_2())) {
            return false;
        }
        if (valor.equals(incentivoOfertasPreS2s.getSelectedOfertapromo2_3())) {
            return false;
        }
